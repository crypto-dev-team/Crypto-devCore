...
#   c) node1 mines 32 blocks, so now node 0 has 60001crdv, node 1 has 4250crdv, node2 has none.
#   d) node0 sends 601 crdv to node2, in two transactions (301 crdv, then 300 crdv).
