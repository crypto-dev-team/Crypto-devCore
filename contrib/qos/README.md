...
This means one can have an always-on cryptodevd instance running, and another local cryptodevd/cryptodev-qt instance which connects to this node and receives blocks from it.
