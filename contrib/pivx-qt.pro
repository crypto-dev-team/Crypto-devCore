...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cryptodev-cli.cpp \
           src/cryptodev-tx.cpp \
           src/cryptodev.cpp \
           src/db.cpp \
           ...
           src/qt/cryptodev.cpp \
           src/qt/cryptodevstrings.cpp \
...
RESOURCES += src/qt/cryptodev.qrc src/qt/cryptodev_locale.qrc

TRANSLATIONS += src/qt/locale/cryptodev_bg.ts \
                src/qt/locale/cryptodev_de.ts \
                src/qt/locale/cryptodev_en.ts \
                src/qt/locale/cryptodev_es.ts \
                src/qt/locale/cryptodev_fi.ts \
                src/qt/locale/cryptodev_fr.ts \
                src/qt/locale/cryptodev_it.ts \
                src/qt/locale/cryptodev_ja.ts \
                src/qt/locale/cryptodev_pl.ts \
                src/qt/locale/cryptodev_pt.ts \
                src/qt/locale/cryptodev_ru.ts \
                src/qt/locale/cryptodev_sk.ts \
                src/qt/locale/cryptodev_sv.ts \
                src/qt/locale/cryptodev_vi.ts \
                src/qt/locale/cryptodev_zh_CN.ts \
                src/qt/locale/cryptodev_zh_TW.ts
