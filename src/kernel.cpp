...
bool CheckProofOfStake(const CBlock block, uint256& hashProofOfStake, std::unique_ptr<CStakeInput>& stake)
{
    ...
    if (tx.IsZerocoinSpend()) {
        ...
        stake = std::unique_ptr<CStakeInput>(new CZCrdvStake(spend));
    } else {
        ...
        CCrdvStake* crdvInput = new CCrdvStake();
        crdvInput->SetInput(txPrev, txin.prevout.n);
        stake = std::unique_ptr<CStakeInput>(crdvInput);
    }
