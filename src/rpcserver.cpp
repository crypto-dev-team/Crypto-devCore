...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cryptodev server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Cryptodev server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cryptodev features */
        {"cryptodev", "masternode", &masternode, true, true, false},
        {"cryptodev", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptodev", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptodev", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptodev", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cryptodev", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cryptodev", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cryptodev", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptodev", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptodev", "startmasternode", &startmasternode, true, true, false},
        {"cryptodev", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptodev", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptodev", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptodev", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptodev", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptodev", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptodev", "mnsync", &mnsync, true, true, false},
        {"cryptodev", "spork", &spork, true, true, false},
        {"cryptodev", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cryptodev-cli " + methodname + " " + args + "\n";
}
