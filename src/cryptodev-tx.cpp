...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Crdvx Core cryptodev-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptodev-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptodev transaction") + "\n" +
                               "  cryptodev-tx [options] -create [commands]   " + _("Create hex-encoded cryptodev transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptodev transaction
