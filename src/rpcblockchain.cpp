...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in cryptodev\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zCRDVsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCRDV denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCRDV denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCRDV denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCRDV denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCRDV denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCRDV denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCRDV denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCRDV denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCRDV denominations\n"
            "  }\n"
            "}\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of cryptodev addresses\n"
            "     \"cryptodevaddress\"   	 	(string) cryptodev address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
