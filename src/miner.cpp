        ...
        for (map<uint256, CTxMemPoolEntry>::iterator mi = mempool.mapTx.begin();
            ...
            for (const CTxIn& txin : tx.vin) {
                ...
                if (tx.IsZerocoinSpend()) {
                    ...
                    //Priority = (age^6+100000)*amount - gives higher priority to zcrdvs that have been in mempool long
                    //and higher priority to zcrdvs that are large in value
...
//begin neg array code
	...
	//For the period before v2 activation, zcrdv will be disabled and previous block's checkpoint is all that will be needed
