...

    {
        ...
        BOOST_FOREACH (MasterKeyMap::value_type& pMasterKey, mapMasterKeys) {
            ...
            if (CCryptoKeyStore::Unlock(vMasterKey)) {
                ...
                if (pMasterKey.second.nDeriveIterations < 1500)
                    pMasterKey.second.nDeriveIterations = 1500;
...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
    ...
    CCrypter crypter;
    int64_t nStartTime = GetTimeMillis();
    crypter.SetKeyFromPassphrase(strWalletPassphrase, kMasterKey.vchSalt, 1500, kMasterKey.nDerivationMethod);
    ...
    if (kMasterKey.nDeriveIterations < 1500)
        kMasterKey.nDeriveIterations = 1500;
