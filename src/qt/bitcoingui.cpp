                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cryptodev Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cryptodev address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptodev: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cryptodev Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cryptodev Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cryptodev"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cryptodev addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cryptodev addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cryptodev: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cryptodev Core help message to get a list with possible Cryptodev command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cryptodev Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptodev network", "", count));
}
...
{
    QString strTitle = tr("Cryptodev Core"); // default title
