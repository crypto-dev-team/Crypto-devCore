...
// Copyright (c) 2016-2018 The Cryptodev developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("CRDV Stake");
    case TransactionRecord::StakeZCRDV:
        return tr("zCRDV Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted CRDV to zCRDV");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zCRDV");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received CRDV from zCRDV");
    case TransactionRecord::ZerocoinSpend_Change_zCrdv:
        return tr("Minted Change as zCRDV from zCRDV Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zCRDV to CRDV");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zCrdv:
        return tr("Anonymous (zCRDV Transaction)");
    case TransactionRecord::StakeZCRDV:
        return tr("Anonymous (zCRDV Stake)");
    case TransactionRecord::SendToSelf:
    default:
