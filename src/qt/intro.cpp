...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptodev Core"),
     ...
     * override -datadir in the cryptodev.conf file in the default data directory
     * (to be consistent with cryptodevd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
