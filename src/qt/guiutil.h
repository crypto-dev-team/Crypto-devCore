...
/** Utility functions used by the Cryptodev Qt UI.
 */
namespace GUIUtil
{
...
// Render Cryptodev addresses in monospace font
...
// Parse "cryptodev:" URI into recipient object, return true on successful parsing
