                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCRDVPathCustom = GetArg("-zcrdvbackuppath", "");
    ...
    if(!strzCRDVPathCustom.empty()) {
        ui->wallet_customzcrdvbackuppath->setText(QString::fromStdString(strzCRDVPathCustom));
        ui->wallet_customzcrdvbackuppath_label->setVisible(true);
        ui->wallet_customzcrdvbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCRDVPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Cryptodev RPC console.") + "<br>" +
