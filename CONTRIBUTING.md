Contributing to Cryptodev Core
============================

The Cryptodev Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cryptodev Core project, and is not to be
confused with overall Cryptodev Network Protocol consensus changes.

Whether a pull request is merged into Cryptodev Core rests with the project merge
...
Patches that change Cryptodev consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cryptodev consensus, it must have been
...
The project leader is the release manager for each Cryptodev Core release.
