...
In order to support loading of multiple wallets in cryptodev-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptodev.cpp.
...
Changes to cryptodev.cpp
----------------------
cryptodev.cpp is the entry point into cryptodev-qt, and as such, will require some minor modifications to provide hooks for
